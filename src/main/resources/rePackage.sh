#!/usr/bin/env bash
cd /root/source/workspace/pushBookToKindle/master
...
cp -f /root/source/workspace/pushBookToKindle/master/target/pushbooktokindle-0.0.1-SNAPSHOT.war /opt/pushbooktokindle-0.0.1-SNAPSHOT.war
